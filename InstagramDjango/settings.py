"""
Django settings for InstagramDjango project.
...
STRIPE_PLAN_IDS_BASIC = config('STRIPE_PLAN_IDS_BASIC')
STRIPE_PLAN_IDS_MEDIUM = config('STRIPE_PLAN_IDS_MEDIUM')
STRIPE_PLAN_IDS_PREMIUM = config('STRIPE_PLAN_IDS_PREMIUM')
