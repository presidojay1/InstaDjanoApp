...
class ProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Profile
        fields = ['id',  'email', 'age', 'has_confirmed_otp', 'number_of_ig_accounts', 
                  'height', 'subscription_plan', 'subscription_end_date', 'subscription_is_valid']
        read_only_fields = ['stripe_customer_id', 'number_of_ig_accounts',
         'has_confirmed_otp', 'subscription_end_date', 'subscription_is_valid', 'subscription_plan']
